...
echo" <b> NAME </b> ";
echo"<br>";
echo "<input type='text' class='thin-line-input' value='$row[name]' name='adminname' required>";
echo"<br>";
echo"<br>";
echo "<b> EMAIL ID </b>";
echo"<br>";
echo "<input type='email' class='thin-line-input' value='$row[email_id]' name='adminemail'   required >";
echo"<br>";
echo"<br>";
echo "<b>PASSWORD</b>";
echo "<br>";
echo "<input type='password' class='thin-line-input' value='$row[password]' name='adminpassword' />";
echo"<br>";
echo"<br>";
echo  "<CENTER>";
