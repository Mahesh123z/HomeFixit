...
&nbsp; &nbsp;<label> <B><h6> EMAIL ID </h6></B>
 <input type="email" class="form-control" style="width:300px;" name="email" placeholder="Email Id" aria-label="Email Id" required >
 </label>
 <br><br>
 &nbsp; &nbsp;<label><B><H6> PASSWORD </H6> </B>
 <input type="password"   maxlength="8" minlength="4"
 class="form-control" style="width:300px;" name="password" placeholder="Password" aria-label="Password"  required >
 </label><br>
 &nbsp; &nbsp; &nbsp;<a href="forgot_user_pass.php" style="font-size : 15px;">Forgot Password?</a>
 <BR>
 <BR>
<CENTER>
