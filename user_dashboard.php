        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto">
                  ...
                  <a href="about2.html" class="nav-item nav-link">About</a>  
                    <div class="nav-item dropdown">
                        ...
                        <?php 
                            ...
                            echo "<a href='view_user_profile1.php?temail=".$_GET['tmail']."' class='dropdown-item'>View Profile</a>";
                            echo "<a href='review.php' class='dropdown-item'>Review</a>";
                            echo "<a href='logout.php' class='dropdown-item'>Sign Out</a>";
                            ?>
                        </div>
                    </div>
					<a href="search_service.php" class="nav-item nav-link">Search Service_Provider</a>
                    <a href="contact1.html" class="nav-item nav-link">Get In Touch</a>
                    <a href="booking_sts.php" class="nav-item nav-link">Booking status</a>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="service.html">Electricial</a>
                    <a class="btn btn-link" href="service.html">Plumbing</a>
                    <a class="btn btn-link" href="service.html">Carpenter</a>
                    <a class="btn btn-link" href="service.html">CCTV Installation</a>
                    <a class="btn btn-link" href="service.html">Painter</a>
                </div>
                <div class="col-lg-3 col-md-6">
